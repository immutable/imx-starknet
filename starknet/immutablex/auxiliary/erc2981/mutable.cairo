...
func ERC2981_Mutable_initializer{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ):
    ERC165_register_interface(IERC2981_ID)
    return ()
end

func ERC2981_Mutable_royaltyInfo{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
...
func ERC2981_Mutable_getDefaultRoyalty{
...
func ERC2981_Mutable_setDefaultRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        receiver : felt, fee_basis_points : felt):
    with_attr error_message("ERC2981_Mutable: fee_basis_points exceeds fee denominator (10000)"):
...
func ERC2981_Mutable_resetDefaultRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}():
...
func ERC2981_Mutable_setTokenRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
...
func ERC2981_Mutable_resetTokenRoyalty{
