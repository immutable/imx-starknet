...
func ERC2981_UniDirectional_Mutable_initializer{
...
func ERC2981_UniDirectional_Mutable_royaltyInfo{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
...
func ERC2981_UniDirectional_Mutable_getDefaultRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (
        receiver : felt, fee_basis_points : felt):
    let (royalty) = ERC2981_UniDirectional_Mutable_default_royalty_info.read()
...
func ERC2981_UniDirectional_Mutable_setDefaultRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        receiver : felt, fee_basis_points : felt):
...
func ERC2981_UniDirectional_Mutable_resetDefaultRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}():
...
func ERC2981_UniDirectional_Mutable_setTokenRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
...
func ERC2981_UniDirectional_Mutable_resetTokenRoyalty{
