...
from starkware.cairo.common.uint256 import (
    Uint256, uint256_add, uint256_le, uint256_check, uint256_mul, uint256_unsigned_div_rem)
...
from immutablex.utils.constants import IERC2981_ID
...
func ERC2981_Flagged_initializer{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ):
...
func ERC2981_Flagged_setMutableFalse{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}():
    ERC2981_Flagged_mutable.write(FALSE)
    return ()
end

func ERC2981_Flagged_royaltyInfo{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        token_id : Uint256, sale_price : Uint256) -> (receiver : felt, royalty_amount : Uint256):
    alloc_locals
...
func ERC2981_Flagged_getDefaultRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (
...
func ERC2981_Flagged_setDefaultRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        receiver : felt, fee_basis_points : felt):
    with_attr error_message("ERC2981_Flagged: fee_basis_points exceeds fee denominator (10000)"):
...
func ERC2981_Flagged_resetDefaultRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}():
...
func ERC2981_Flagged_setTokenRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
...
func ERC2981_Flagged_resetTokenRoyalty{
