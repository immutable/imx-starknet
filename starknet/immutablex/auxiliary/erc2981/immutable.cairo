...
func ERC2981_Immutable_initializer{
...
func ERC2981_Immutable_royaltyInfo{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
...
func ERC2981_Immutable_getRoyalty{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (
        receiver : felt, fee_basis_points : felt):
    let (royalty) = ERC2981_Immutable_royalty_info.read()
...
func _set_contract_royalty{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        receiver : felt, fee_basis_points : felt):
    with_attr error_message("ERC2981_Immutable: fee_basis_points exceeds fee denominator (10000)"):
