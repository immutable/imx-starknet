...
from immutablex.token.erc721.library import ERC721_exists
from immutablex.utils.constants import IERC721_METADATA_ID
...
func ERC721_Token_Metadata_initializer{
...
func ERC721_Token_Metadata_tokenURI{
    ...
    if token_uri_len != 0:
        ...
        _tokenURI(token_id, token_uri_len, token_uri_value)
...
func ERC721_Token_Metadata_setBaseTokenURI{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        base_token_uri_len : felt, base_token_uri : felt*):
    _setBaseTokenURI(base_token_uri_len, base_token_uri)
    ERC721_base_token_uri_len.write(base_token_uri_len)
    return ()
end

func ERC721_Token_Metadata_setTokenURI{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    _setTokenURI(token_id, token_uri_len, token_uri)
    ERC721_token_uri_len.write(token_id, token_uri_len)
    return ()
end

func ERC721_Token_Metadata_resetTokenURI{
        syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(token_id : Uint256):
    ERC721_Token_Metadata_setTokenURI(token_id, 0, &[0])
    return ()
end
...
func _tokenURI{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    _tokenURI(token_id, token_uri_len - 1, token_uri_value + 1)
    return ()
end

func _setTokenURI{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        token_id : Uint256, token_uri_len : felt, token_uri : felt*):
    if token_uri_len == 0:
        return ()
    end
    ...
    _setTokenURI(token_id, token_uri_len - 1, token_uri + 1)
    return ()
end
...
func _baseTokenURI{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    _baseTokenURI(base_token_uri_len - 1, base_token_uri + 1)
    return ()
end
...
func _setBaseTokenURI{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    _setBaseTokenURI(base_token_uri_len - 1, base_token_uri + 1)
    return ()
end
